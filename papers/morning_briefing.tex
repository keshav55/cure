...
What & Dataset & AUROC \\
\midrule
Our scorer, wrong alleles & NeoRanking 125K & 0.156 \\
Our scorer, TESLA synthetic & TESLA 608 & 0.609 \\
Right features, right alleles & NeoRanking 125K & 0.958 \\
Published neural networks & Various & 0.58--0.81 \\
\bottomrule
\end{tabular}
\end{center}

The 0.958 uses pre-computed features from the dataset, not our scorer. Our scorer with patient-matched alleles is being validated right now (running overnight).
