...
\begin{tabular}{@{}lrrr@{}}
\toprule
Method & recall@20 & Worse & $p$ vs.\ binding \\
\midrule
Binding only & 0.529 & --- & --- \\
Ensemble only & 0.604 & 9 & 0.067 \\
\textbf{Safety net (10+10)} & \textbf{0.636} & \textbf{2} & \textbf{0.002} \\
\bottomrule
\end{tabular}
\caption{LOPO evaluation (73 patients). The safety net combines binding's reliability with the ensemble's discovery of non-obvious candidates.}
\end{table}
